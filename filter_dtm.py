...
def filter_dtm_by_document_frequency(dtm_file, word_freq_file, min_docs=10, output_file=None):
    """
    문서 빈도가 최소값 이상인 단어들로만 DTM을 필터링
    
    Args:
        dtm_file (str): 원본 DTM CSV 파일 경로
        word_freq_file (str): 단어별 문서 빈도 CSV 파일 경로
    ...
    print(f"단어별 문서 빈도 파일 읽는 중: {word_freq_file}")
...
def main():
    """메인 함수"""
    dtm_file = "/Users/bumjunekim/Desktop/qubit/qubit_DTM.csv"
    word_freq_file = "/Users/bumjunekim/Desktop/qubit/word_document_frequency.csv"
    output_file = "/Users/bumjunekim/Desktop/qubit/qubit_filtered_DTM.csv"
