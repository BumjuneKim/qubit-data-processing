...
def main():
    """메인 함수"""
    dtm_file = os.path.join(os.path.dirname(__file__), 'photonic', 'phase3_DTM.csv')
    output_file = os.path.join(os.path.dirname(__file__), 'photonic', 'phase3_filtered_DTM.csv')
