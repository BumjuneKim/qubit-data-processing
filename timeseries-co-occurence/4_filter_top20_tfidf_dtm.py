...
def filter_tfidf_data():
    ...
    df = pd.read_csv(os.path.join(os.path.dirname(__file__), 'photonic', 'phase3_TFIDF_DTM.csv'))
    ...
    output_file = os.path.join(os.path.dirname(__file__), 'photonic', 'phase3_TFIDF_filtered_TOP20_DTM.csv')
