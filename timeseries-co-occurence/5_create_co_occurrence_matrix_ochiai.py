...
if __name__ == "__main__":
    input_file = os.path.join(os.path.dirname(__file__), 'photonic', 'all_TFIDF_filtered_TOP20_DTM.csv')
    output_file = os.path.join(os.path.dirname(__file__), 'photonic', 'co-occurrence-matrix.csv')
